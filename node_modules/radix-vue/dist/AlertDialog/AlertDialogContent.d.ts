...
import { type DialogContentEmits, type DialogContentProps } from '../Dialog';
interface AlertDialogContentContextValue {
    onCancelElementChange(el: HTMLElement | undefined): void;
}
export declare const ALERT_DIALOG_CONTENT_INJECTION_KEY: InjectionKey<AlertDialogContentContextValue>;
